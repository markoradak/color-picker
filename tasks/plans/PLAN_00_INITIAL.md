...
- [x] **1.1** Initialize monorepo root
...
- [x] **2.1** Define TypeScript types (`src/types.ts`)
...
- [x] **2.2** Color utilities (`src/utils/color.ts`)
...
- [x] **2.3** Gradient utilities (`src/utils/gradient.ts`)
...
- [x] **2.4** CSS conversion utilities (`src/utils/css.ts`)
...
- [x] **2.5** Position utilities (`src/utils/position.ts`)
...
- [x] **2.6** Unit tests for all utilities
...
- [x] **3.1** `usePointerDrag` hook (`src/hooks/use-pointer-drag.ts`)
...
- [x] **3.2** `useColorPicker` hook (`src/hooks/use-color-picker.ts`)
...
- [x] **3.3** `useGradient` hook (`src/hooks/use-gradient.ts`)
...
- [x] **3.4** Context system (`src/components/color-picker.tsx` -- context only)
...
- [x] **4.1** `<ColorPicker>` root component (`src/components/color-picker.tsx`)
...
- [x] **4.2** `<ColorPicker.Trigger>` (`src/components/trigger.tsx`)
...
- [x] **4.3** `<ColorPicker.Content>` (`src/components/content.tsx`)
...
- [x] **4.4** `<ColorPicker.Area>` (`src/components/area.tsx`)
...
- [x] **4.5** `<ColorPicker.HueSlider>` (`src/components/hue-slider.tsx`)
...
- [x] **4.6** `<ColorPicker.AlphaSlider>` (`src/components/alpha-slider.tsx`)
  - Horizontal slider with checkerboard background + color overlay
  - Draggable thumb via `usePointerDrag`
  - Updates alpha in context
  - Keyboard support: left/right arrows

- [x] **4.7** `<ColorPicker.Input>` (`src/components/input.tsx`)
...
- [x] **4.8** `<ColorPicker.FormatToggle>` (`src/components/format-toggle.tsx`)
  - Cycles through HEX -> RGB -> HSL -> HEX
  - Button with current format label
  - Updates context format which changes Input display

- [x] **4.9** `<ColorPicker.EyeDropper>` (`src/components/eye-dropper.tsx`)
...
- [x] **4.10** `<ColorPicker.Swatches>` (`src/components/swatches.tsx`)
...
- [x] **5.1** `<ColorPicker.GradientEditor>` (`src/components/gradient-editor.tsx`)
...
- [x] **5.2** `<GradientPreview>` (`src/components/gradient-preview.tsx`)
...
- [x] **5.3** `<GradientStops>` (`src/components/gradient-stops.tsx`)
...
- [x] **5.4** Nested color picker for gradient stops
...
- [x] **5.9** Gradient component tests
...
- [x] **6.1** `<ColorPickerPopover>` (`src/components/presets.tsx`)
...
- [x] **7.1** Landing page (`apps/web/app/page.tsx`)
...
- [x] **7.2** Playground page (`apps/web/app/playground/page.tsx`)
...
- [x] **7.4** Mobile responsive layout
...
- [x] **8.1** Comprehensive unit tests
...
- [x] **8.2** Component integration tests
...
- [x] **8.4** Bundle size optimization
