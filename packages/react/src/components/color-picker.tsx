...
ColorPicker.AreaGradient = ColorPickerAreaGradient;
ColorPicker.AreaThumb = ColorPickerAreaThumb;
ColorPicker.HueSlider = ColorPickerHueSlider;
ColorPicker.HueSliderTrack = ColorPickerHueSliderTrack;
ColorPicker.HueSliderThumb = ColorPickerHueSliderThumb;
ColorPicker.AlphaSlider = ColorPickerAlphaSlider;
ColorPicker.AlphaSliderTrack = ColorPickerAlphaSliderTrack;
ColorPicker.AlphaSliderThumb = ColorPickerAlphaSliderThumb;
...
ColorPicker.ModeSelectorItem = ColorPickerModeSelectorItem;
