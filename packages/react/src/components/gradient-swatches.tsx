...
const DEFAULT_GRADIENT_SWATCHES: GradientValue[] = [
  ...
  // Radial
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r1a", color: "#FFD700", position: 0 }, { id: "r1b", color: "#FF4500", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r2a", color: "#BF5AE0", position: 0 }, { id: "r2b", color: "#2D0845", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r3a", color: "#00F5A0", position: 0 }, { id: "r3b", color: "#00408A", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r4a", color: "#FF758C", position: 0 }, { id: "r4b", color: "#1A0010", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r5a", color: "#E0F4FF", position: 0 }, { id: "r5b", color: "#1B3A5C", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r6a", color: "#FFC3A0", position: 0 }, { id: "r6b", color: "#870057", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r7a", color: "#93F9B9", position: 0 }, { id: "r7b", color: "#1D976C", position: 100 }] },
  { type: "radial", centerX: 50, centerY: 50, stops: [{ id: "r8a", color: "#485563", position: 0 }, { id: "r8b", color: "#0D0D0D", position: 100 }] },
  // Conic
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c1a", color: "#ff0000", position: 0 }, { id: "c1b", color: "#ffff00", position: 17 }, { id: "c1c", color: "#00ff00", position: 33 }, { id: "c1d", color: "#00ffff", position: 50 }, { id: "c1e", color: "#0000ff", position: 67 }, { id: "c1f", color: "#ff00ff", position: 83 }, { id: "c1g", color: "#ff0000", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c2a", color: "#F5AF19", position: 0 }, { id: "c2b", color: "#F12711", position: 50 }, { id: "c2c", color: "#F5AF19", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c3a", color: "#FF6B6B", position: 0 }, { id: "c3b", color: "#4ECDC4", position: 25 }, { id: "c3c", color: "#45B7D1", position: 50 }, { id: "c3d", color: "#96E6A1", position: 75 }, { id: "c3e", color: "#FF6B6B", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c4a", color: "#E8E8E8", position: 0 }, { id: "c4b", color: "#7F7F7F", position: 25 }, { id: "c4c", color: "#E8E8E8", position: 50 }, { id: "c4d", color: "#7F7F7F", position: 75 }, { id: "c4e", color: "#E8E8E8", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c5a", color: "#FF00FF", position: 0 }, { id: "c5b", color: "#00FFFF", position: 50 }, { id: "c5c", color: "#FF00FF", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c6a", color: "#2D0845", position: 0 }, { id: "c6b", color: "#614385", position: 25 }, { id: "c6c", color: "#516395", position: 50 }, { id: "c6d", color: "#614385", position: 75 }, { id: "c6e", color: "#2D0845", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c7a", color: "#134E5E", position: 0 }, { id: "c7b", color: "#71B280", position: 50 }, { id: "c7c", color: "#134E5E", position: 100 }] },
  { type: "conic", angle: 0, centerX: 50, centerY: 50, stops: [{ id: "c8a", color: "#FF4E50", position: 0 }, { id: "c8b", color: "#FC913A", position: 25 }, { id: "c8c", color: "#F9D423", position: 50 }, { id: "c8d", color: "#FC913A", position: 75 }, { id: "c8e", color: "#FF4E50", position: 100 }] },
  // Mesh
