...
export const styles = {
  ...
  modeSelectorItem:
    "cursor-pointer rounded-md px-1.5 py-1.5 text-center text-xs font-medium outline-none transition-shadow disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-emerald-500 data-[active]:bg-white data-[active]:shadow-sm dark:data-[active]:bg-zinc-700 dark:text-zinc-300 dark:data-[active]:text-zinc-100",

  area: "relative aspect-[3/2] w-full cursor-crosshair rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  hueSlider:
    "relative h-3 w-full cursor-pointer rounded-full outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  inputClassNames: {
    formatToggle:
      "shrink-0 select-none rounded-md border border-zinc-300 bg-white px-2 h-8 text-xs font-medium outline-none disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-700",
    field:
      "w-full rounded-md border border-zinc-300 bg-white px-2 h-8 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 data-[has-tokens=icon]:pr-8 data-[has-tokens=matched]:pr-18",
    tokenBadge:
  ...
  eyeDropper:
    "inline-flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-md border border-zinc-300 bg-white outline-none disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-emerald-500 hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700",
  ...
  swatches: "gap-1",
  swatch:
    "relative aspect-square rounded-md border border-zinc-200 outline-none disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-emerald-500 data-[active]:ring-1 data-[active]:ring-zinc-900 dark:border-zinc-600 dark:data-[active]:ring-zinc-100",
  ...
  gradientEditorClassNames: {
    ...
    stopDot:
      "z-[2] h-3 w-3 cursor-pointer rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.2)] outline-none data-[active]:ring-2 data-[active]:ring-emerald-500",
    baseColor:
  ...
  trigger:
    "relative inline-flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 p-1 outline-none disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-600",
  triggerClassNames: {
  ...
  inputTrigger:
    "inline-flex h-10 w-full cursor-pointer items-center gap-1.5 rounded-lg border border-zinc-300 bg-white px-1.5 text-left outline-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 focus-within:ring-2 focus-within:ring-emerald-500 dark:border-zinc-600 dark:bg-zinc-900",
