...
export const styles = {
  content:
    "z-50 flex w-72 flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-3 shadow-lg dark:border-zinc-700 dark:bg-zinc-900",

  modeSelector:
    "flex justify-between rounded-lg border border-zinc-200 bg-zinc-100 p-0.5 dark:border-zinc-700 dark:bg-zinc-800",
  modeSelectorItem:
    "cursor-pointer rounded-md px-1.5 py-1.5 text-center text-xs font-medium outline-none transition-[box-shadow] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset data-[active]:bg-white data-[active]:shadow-sm dark:data-[active]:bg-zinc-700 dark:data-[active]:shadow-none dark:text-zinc-300 dark:data-[active]:text-zinc-100",

  area: "relative aspect-[3/2] w-full cursor-crosshair rounded-lg outline-none transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  hueSlider:
    "relative h-3 w-full cursor-pointer rounded-full outline-none transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  inputClassNames: {
    formatToggle:
      "shrink-0 select-none rounded-md border border-zinc-300 bg-white px-2 h-8 text-xs font-medium outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-700",
    field:
      "w-full rounded-md border border-zinc-300 bg-white px-2 h-8 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50 focus:border-ring focus:ring-1 focus:ring-offset-2 focus:ring-ring focus:ring-offset-ring-offset dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 data-[has-tokens=icon]:pr-8 data-[has-tokens=matched]:pr-18",
    tokenBadge:
  ...
  eyeDropper:
    "inline-flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-md border border-zinc-300 bg-white outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700",
  ...
  swatches: "gap-1",
  swatch:
    "relative aspect-square rounded-md border border-zinc-200 outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset data-[active]:ring-1 data-[active]:ring-zinc-900 dark:border-zinc-600 dark:data-[active]:ring-zinc-100",
  ...
  gradientEditorClassNames: {
    ...
    stopDot:
      "z-[2] h-3 w-3 cursor-pointer rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.2)] outline-none transition-shadow focus-visible:ring-2 focus-visible:ring-ring data-[active]:ring-2 data-[active]:ring-ring",
    baseColor:
      "bottom-2 left-2 z-[2] h-5 w-5 cursor-pointer rounded border border-white/50 shadow-sm outline-none transition-shadow focus-visible:ring-2 focus-visible:ring-ring",
    contextMenu:
  ...
  trigger:
    "relative inline-flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 p-1 outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring focus-visible:ring-offset-ring-offset dark:border-zinc-600",
  triggerClassNames: {
  ...
  inputTrigger:
    "inline-flex h-10 w-full cursor-pointer items-center gap-1.5 rounded-lg border border-zinc-300 bg-white px-1.5 text-left outline-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-ring focus-within:ring-offset-ring-offset dark:border-zinc-600 dark:bg-zinc-900",
