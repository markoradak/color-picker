...
export const styles = {
  ...
  modeSelectorItem:
    "cursor-pointer rounded-md px-1.5 py-1.5 text-center text-xs font-medium outline-none transition-[box-shadow] disabled:cursor-not-allowed disabled:opacity-50 ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring data-[active]:bg-white data-[active]:shadow-sm dark:data-[active]:bg-zinc-700 dark:text-zinc-300 dark:data-[active]:text-zinc-100",

  area: "relative aspect-[3/2] w-full cursor-crosshair rounded-lg outline-none transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  hueSlider:
    "relative h-3 w-full cursor-pointer rounded-full outline-none transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
  ...
  inputClassNames: {
    formatToggle:
      "shrink-0 select-none rounded-md border border-zinc-300 bg-white px-2 h-8 text-xs font-medium outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-700",
    field:
      "w-full rounded-md border border-zinc-300 bg-white px-2 h-8 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50 ring-offset-2 ring-offset-ring-offset focus:border-ring focus:ring-1 focus:ring-ring dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 data-[has-tokens=icon]:pr-8 data-[has-tokens=matched]:pr-18",
    tokenBadge:
  ...
  eyeDropper:
    "inline-flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-md border border-zinc-300 bg-white outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700",
  ...
  swatches: "gap-1",
  swatch:
    "relative aspect-square rounded-md border border-zinc-200 outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring data-[active]:ring-1 data-[active]:ring-zinc-900 dark:border-zinc-600 dark:data-[active]:ring-zinc-100",
  ...
  trigger:
    "relative inline-flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 p-1 outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-[box-shadow] ring-offset-2 ring-offset-ring-offset focus-visible:ring-2 focus-visible:ring-ring dark:border-zinc-600",
  triggerClassNames: {
